...
public class AnimationConfig extends Transition {
     ...
     */
    public AnimationConfig(final Node node, final Timeline timeline) {
     ...
     */
    public AnimationConfig(final Node node, final Timeline timeline, final boolean useCache) {
        this.node = node;
